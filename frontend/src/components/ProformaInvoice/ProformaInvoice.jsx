        ...
        <div class="page" id="invoice">
          ...
          <div style="margin-top:auto;">
            ...
            <div>
              ...
              <div class="tax-row"><span>SGST @ 9%</span><span>${isIntraState ? totals.sgst.toFixed(2) : '0.00'}</span></div>
              <div class="tax-row"><span>CGST @ 9%</span><span>${isIntraState ? totals.cgst.toFixed(2) : '0.00'}</span></div>
              <div class="tax-row"><span>IGST @ 18%</span><span>${!isIntraState ? totals.igst.toFixed(2) : '0.00'}</span></div>
        ...
        <div style={{ marginTop: 'auto' }}>
          ...
          <div className="proforma-tax-block">
            ...
            <div className="proforma-tax-row proforma-hl">
              <span>SGST @ 9%</span>
              <span>₹{isIntraState ? totals.sgst.toFixed(2) : '0.00'}</span>
            </div>
            <div className="proforma-tax-row proforma-hl">
              <span>CGST @ 9%</span>
              <span>₹{isIntraState ? totals.cgst.toFixed(2) : '0.00'}</span>
            </div>
            <div className="proforma-tax-row proforma-hl">
              <span>IGST @ 18%</span>
              <span>₹{!isIntraState ? totals.igst.toFixed(2) : '0.00'}</span>
            </div>
            <div className="proforma-tax-row proforma-hl">
              <span>Total Tax</span>
